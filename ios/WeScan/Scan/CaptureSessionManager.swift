...
final class CaptureSessionManager: NSObject, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    @discardableResult private func displayRectangleResult(rectangleResult: RectangleDetectorResult) -> Quadrilateral {
        ...
        let quad = Quadrilateral(topLeft: rectangleResult.rectangle.topLeft, topRight: rectangleResult.rectangle.topRight, bottomRight: rectangleResult.rectangle.bottomRight, bottomLeft: rectangleResult.rectangle.bottomLeft).toCartesian(withHeight: rectangleResult.imageSize.height)
